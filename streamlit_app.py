...
with st.sidebar:
    ...
    do_not_buy_list_str = st.text_area("Do Not Buy List (Optional)", "APPN, BL, BTG, GLD, GLDM, ICCM, IOVA, PSLV, QID, QQQU, RDDT, SGOL, SLV, SPXU, SQQQ, TQQQ, TSLY, TZA, ULTY, VIST, VRNS", height=100, help="Tickers you do not wish to buy...")
