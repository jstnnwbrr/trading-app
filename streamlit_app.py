...
with st.sidebar:
    ...
    do_not_buy_list_str = st.text_area("Do Not Buy List (Optional)",  "AI, APLS, APPN, AST, AU, AUR, BITF, BL, BTBT, BTCZ, BTDR, BTG, CGBS, DNN, ETHA, EXK, GDX, GLD, GLDM, GOOG, ICCM, IOVA, JDST, LDTC, LLC, MARA, MJNA, MSTR, MSTU, MSTX, MSTZ, NGD, NIO, NXP, PAAS, PLTD, PSLV, QID, QQQU, QUBT, RDDT, RIOT, SGOL, SLGC, SLV, SOUN, SOXL, SOXS, SPDN, SPXU, SQQQ, SRM, TQQQ, TSDD, TSLL, TSLQ, TSLS, TSLY, TTD, TZA, ULTY, VIST, VRNS, WULF", height=100, help="Tickers you do not wish to buy...")
